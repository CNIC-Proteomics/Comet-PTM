...
#include <bitset>	// spiros comet-ptm
...
private:
   ...
   double             _pdAAforwardDelta[MAX_PEPTIDE_LEN]; // spiros comet-ptm
   double             _pdAAreverseDelta[MAX_PEPTIDE_LEN]; // spiros comet-ptm
   ...
   unsigned int       _uiBinnedIonMassesDelta[MAX_FRAGMENT_CHARGE+1][9][MAX_PEPTIDE_LEN]; // spiros comet-ptm
