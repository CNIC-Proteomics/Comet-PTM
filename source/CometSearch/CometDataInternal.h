...
struct Results 
{
   ...
   float  fScoreQ;
   float  fXcorr;
   double dDeltaXcorrMass; // spiros comet-ptm
   int    iDuplicateCount;
   int    iLenPeptide;
   int    iRankSp;
   int    iMatchedIons;
...
// spiros start comet-ptm
   char szDeltaYSeries[MAX_PEPTIDE_LEN*2];   // spiros
   char szDeltaBSeries[MAX_PEPTIDE_LEN*2];   // spiros
